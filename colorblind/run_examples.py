...
def main():
    ...
    Core.simulate(input_path='Check/ex_original.jpg',
                  return_type='save',
                  save_path='Check/ex_simulate_protanopia.png',
    ...
    Core.simulate(input_path='Check/ex_original.jpg',
                  return_type='save',
                  save_path='Check/ex_simulate_deutranopia.png',
    ...
    Core.simulate(input_path='Check/ex_original.jpg',
                  return_type='save',
                  save_path='Check/ex_simulate_tritanopia.png',
    ...
    Core.simulate(input_path='Check/ex_original.jpg',
                  return_type='save',
                  save_path='Check/ex_simulate_hybrid.png',
    ...
    Core.correct(input_path='Check/ex_original.jpg',
                 return_type='save',
                 save_path='Check/ex_corrected_protanopia.png',
                 protanopia_degree=0.9,
                 deutranopia_degree=0.0)

    # Also simulate the corrected image to see difference.
    Core.simulate(input_path='Check/ex_corrected_protanopia.png',
                  return_type='save',
                  save_path='Check/ex_simulate_corrected_protanopia.png',
                  simulate_type='protanopia',
                  simulate_degree_primary=0.9)
    ...
    Core.correct(input_path='Check/ex_original.jpg',
                 return_type='save',
                 save_path='Check/ex_corrected_deutranopia.png',
                 protanopia_degree=0.0,
                 deutranopia_degree=1.0)

    # Also simulate the corrected image to see difference.
    Core.simulate(input_path='Check/ex_corrected_deutranopia.png',
                  return_type='save',
                  save_path='Check/ex_simulate_corrected_deutranopia.png',
                  simulate_type='deutranopia',
                  simulate_degree_primary=0.9)
    ...
    Core.correct(input_path='Check/ex_original.jpg',
                 return_type='save',
                 save_path='Check/ex_corrected_hybrid.png',
